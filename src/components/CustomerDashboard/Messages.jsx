// src/components/CustomerDashboard/Messages.jsx
    ...
    async function fetchConversations() {
      const { data, error } = await supabase
        ...
        .select(
          `
          *,
          providers(id, business_name, verification_status, base_rate),
          jobs(service_name, status)
        `
        )
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900 flex items-center gap-2">
                    {selectedConversation.providers?.business_name}
                    {selectedConversation.providers?.verification_status ===
                      "verified" && (
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between mb-1">
            <h4 className="font-semibold text-slate-900 text-sm truncate flex items-center gap-1">
              {conversation.providers?.business_name}
              {conversation.providers?.verification_status === "verified" && (
